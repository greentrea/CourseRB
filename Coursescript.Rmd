...
arcgislayers::publish_layer(bars_sf_important, 
                            ...
                            publish_params = .publish_params(name="Bars in Zurich",description = "Schweiz Tourismus Zürich: Bars und Lounges in Zürich und der Region unterteilt in Restaurant-Bar, Afterwork, Ausgewählte Spirituosen, Cocktailbar, Freiluft-Bereich, Hotelbar, Musikbar / Live Music, Pub /, Spezielle Biere, Quartierbar, Weinbar und Kulturlokal.", copyright = "Info see  https://data.stadt-zuerich.ch/dataset/zt_bars"))
...
```{r exercise, echo=FALSE, eval=FALSE}
